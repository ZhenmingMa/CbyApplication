...
public class MobileManager {
    ...
    public class PhoneInfo2 {
        ...
        // 是否同意ACCESS_COARSE_LOCATION权限
        private boolean isGranterACCESS_COARSE_LOCATIONPermission() {
        ...
        public String getPhoneLocation() {
            if (isGranterACCESS_COARSE_LOCATIONPermission())
                return telManager.getCellLocation().toString();
            else
                return "";
        }

        public String getPhoneSNCode() {
            ...
            for (String key : propertys) {
                try {
                    ...
                    if ((v = (String) systemProperties_get.invoke(null, key)) != null)
                        return v;
                } catch (Exception e) {
                    e.printStackTrace();
                    return null;
        ...
        /**
         * 设备运营商MNC 中国移动 0 2 7 中国联通1 6 中国电信3 5
         */
        public String getPhoneMNCCode() {
            String ProvidersName = null;
            // 返回唯一的用户ID;就是这张卡的编号神马的
            String IMSI = telManager.getSubscriberId();
            // IMSI号前面3位460是国家，紧接着后面2位00 02是中国移动，01是中国联通，03是中国电信。
            if (IMSI != null) {
                if (IMSI.startsWith("46000") || IMSI.startsWith("46007")) {
                    return "0";
