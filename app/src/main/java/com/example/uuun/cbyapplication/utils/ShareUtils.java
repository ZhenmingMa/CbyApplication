...
//        oks.setTitle("这里是分享的title");
//        // titleUrl是标题的网络链接，仅在人人网和QQ空间使用
//        oks.setTitleUrl("http://101.200.53.112:8080//images/68976310798640530.jpg");
//        // text是分享文本，所有平台都需要这个字段
//        oks.setText("我是分享文本");
//        // imagePath是图片的本地路径，Linked-In以外的平台都支持此参数
//        String imgUrl = "http://101.200.53.112:8080//images/68976310798640530.jpg";
